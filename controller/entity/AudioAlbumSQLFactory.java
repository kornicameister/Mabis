...
public class AudioAlbumSQLFactory extends SQLFactory {
	 ...
	 * Jeśli dany gatunek jest już w bazie pobierany jest jedynie jego identyfikator,
	 * w innym wypadku gatunek jest umieszczany w bazie danych, a następnie pobierany jest jego 
	 * identyfikator
	 */
