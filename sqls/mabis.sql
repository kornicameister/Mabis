...
create algorithm=temptable definer=root@localhost sql security definer view AudioAlbumListView as SELECT  
        ...
        aa.trackList,
        aa.totalTime,
        (select p.idPicture from mabis.picture p where p.idPicture = aa.frontCover) as frontCoverId,
        (select p.image from mabis.picture p where p.idPicture = aa.frontCover) as frontCoverPath,
        (select p.hash from mabis.picture p where p.idPicture = aa.frontCover) as frontCoverHash,
        (select p.idPicture from mabis.picture p where p.idPicture = aa.backCover) as backCoverId,
        (select p.image from mabis.picture p where p.idPicture = aa.backCover) as backCoverPath,
        (select p.hash from mabis.picture p where p.idPicture = aa.backCover) as backCoverHash,
        (select p.idPicture from mabis.picture p where p.idPicture = aa.cdCover) as cdCoverId,
        (select p.image from mabis.picture p where p.idPicture = aa.cdCover) as cdCoverPath,
        (select p.hash from mabis.picture p where p.idPicture = aa.cdCover) as cdCoverHash,
        b.idBand,
        b.name as bandName,
        (select p.idPicture from mabis.picture p where p.idPicture = b.avatar) as bandImageId,
        (select p.image from mabis.picture p where p.idPicture = b.avatar) as bandImagePath,
